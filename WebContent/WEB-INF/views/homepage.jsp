...
<html>
<head>
<title>Popcorn Flavor | Home</title>
...
<link href="${pageContext.request.contextPath}/css/styles.css" rel="stylesheet" type="text/css" media="all" >
<!-- Custom Theme files -->
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/easyResponsiveTabs.js"></script>
...
<body>
  ...
  <div class="modal-dialog">
	...
	<span class="pull-right login-title login-title-username custom-username-span">${sessionScope.username}</span>
	<!---pop-up-box---->
	<link href="${pageContext.request.contextPath}/css/popuo-box.css" rel="stylesheet" type="text/css">
...
$('#myModal').modal('show');
		...
		<div class="container">
		  <div class="main-content">
			<div class="header">
				<div class="logo">
					<a href="index.html"><h1>Popcorn Flavor</h1></a>
				</div>
				<div class="search">
					<div class="search2">
						<spring:form method="post" commandName="search-form">
							<form method="post" commandName="movieName"  class="form-search-bar">
								...
								<input type="text" id="ceva" name="searchName" value="Search for a movie, play, event, sport or more" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search for a movie, play, event, sport or more';}"/>
							</form>
						</spring:form>
					</div>
				</div>
		...
		<div class="review-slider">
			 <ul id="flexiselDemo1">
				<c:forEach var="mv" items="${listMovies}">
					<li>
						<a href="movies.html"><img src="images/${mv.img}" alt=""/></a>
						<div class="slide-title"><h4>${mv.title}</div>
						<div class="date-city">
							<h5>${mv.beginYear}</h5>
							<h6>${mv.type}</h6>
				    ...
				    <c:otherwise>
		<div class="review-slider">
			 <ul id="flexiselDemo1a">
					      	<c:forEach var="movie" items="${searchResults}" varStatus="status">
					      	<li>
					      		<a href="movies.html"><img src="images/${movie.img}" alt=""/></a>
					      		<div class="slide-title"><h4>${movie.title}</div>
								<div class="date-city">
									<h5>${movie.beginYear}</h5>
									<h6>${movie.type}</h6>
									<div class="buy-tickets">
										<a href="movie-select-show.html">BUY TICKETS</a>
									</div>
